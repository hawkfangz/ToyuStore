<%-- 
    ...
    Created on : Feb 21, 2023, 5:34:00 AM
    Author     : phanh
--%>
...
<html>
    ...
    <body>
        ...
        <c:if test="${empty manufacturerList}">
            <c:redirect url="manufacturers" />
        </c:if>
        <div class="container type-table">
            <a class="btn btn-primary " href="manufacturers?action=create">Create</a>
            <br>
            <table class="table type-table">
                ...
                <c:forEach var="manufacturer" items="${manufacturerList}">
                    <%--<c:if test="${manufacturer.status == 0}">--%>
                    <tr>
