<%-- 
    Document   : type_form
    Created on : Feb 21, 2023, 7:22:59 PM
    Author     : phanh
--%>
    ...
    <body>
        ...
        <div class="container">
            ...
            <c:if test="${param.action == 'edit'}">
                <h2>Edit</h2>
                <c:set var="object" value="${type}" />
                <form method="post" action="types">
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input class="form-control" name="name" id="name" value="${type.getName()}"></input>
                    </div>
                    <div class="form-group">
                        <label for="description">Description:</label>
                        <textarea class="form-control" name="description" id="description" rows="3">${type.getDes()}</textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <c:if test="${type.status == 0}">
                            <label>
                                <input name="status" type="checkbox" id="enable-checkbox">
                                <span id="enable-text">Status: Disable</span>
                            </label>
                        </c:if>
                    </div>
        ...
        <script>
            $(document).ready(function () {
                $("#enable-checkbox").change(function () {
                    if ($(this).is(":checked")) {
                        $("#enable-text").text("Status: Enable");
                        $(this).val(1);
                    } else {
                        $("#enable-text").text("Status: Disable");
                        $(this).val(0);
                    }
                });
            });
